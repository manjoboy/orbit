// ============================================================================
// Mock API — Daily Briefing
// Simulates a network call; returns properly typed data from mock-data.ts.
// This function will eventually call the real /api/briefing endpoint.
// ============================================================================
...
// ─── Mock Data (inline, mirrors mock-data.ts shapes with proper types) ──────

const mockPriorityInbox: PriorityItem[] = [
  {
    id: 'pi-1',
    type: 'message',
    source: 'SLACK',
    ...
    summary:
      'Flagged a critical dependency issue with the auth service migration — needs your input on whether to proceed with the workaround or delay the release by 2 days.',
    urgencyScore: 0.92,
  ...
  },
  {
    ...
    summary:
      'CFO is requesting your updated headcount projections by EOD. Attached the revised template with the new cost centers.',
    urgencyScore: 0.85,
    importanceScore: 0.8,
    compositeScore: 0.83,
    suggestedAction: 'Reply',
  ...
  },
  {
    ...
    summary:
      'Jordan submitted the architecture doc for the new SSO system. 3 team members have already reviewed — waiting on your approval to move to implementation.',
    urgencyScore: 0.7,
  ...
  },
  {
    ...
    summary:
      'Major refactor touching 14 files. Alex has been waiting 2 days for your review. Tests are passing.',
    urgencyScore: 0.65,
    importanceScore: 0.6,
    compositeScore: 0.63,
    suggestedAction: 'Review',
  ...
  },
  {
    ...
    summary:
      'Shared updated mockups for the dashboard redesign. Wants your feedback before the design review on Thursday.',
    urgencyScore: 0.45,
  ...
  },
  {
    ...
    summary:
      'Intercom announced their new AI Agent Builder for enterprise customers. This directly competes with your Q2 roadmap item.',
    urgencyScore: 0.6,
    importanceScore: 0.7,
    compositeScore: 0.65,
...
const mockMeetings: MeetingBrief[] = [
  {
    id: 'mtg-1',
    ...
    attendees: [
      ...
      { name: 'Jordan Liu', title: 'Engineer II', relationshipHealth: 0.9 },
    ],
    prepNotes: {
      lastMeetingSummary:
        'Discussed auth migration timeline. Sarah flagged risk with 3rd-party dependency. Agreed to revisit after load testing.',
      openActionItems: [
      ...
      attendeeContext:
        'Sarah: last spoke yesterday; Alex: last spoke 3d ago; Jordan: last spoke yesterday',
    },
  ...
  },
  {
    ...
    attendees: [
      ...
      { name: 'Sarah Chen', title: 'Staff Engineer', relationshipHealth: 0.85 },
      { name: 'Tom Baker', title: 'Head of Sales', relationshipHealth: 0.6 },
    ],
    prepNotes: {
      lastMeetingSummary:
        'Reviewed Q1 OKR results. Product velocity was below target. Mei pushed for more aggressive Q2 goals. David raised budget constraints.',
      openActionItems: [
      ...
      attendeeContext:
        'Mei: visibility gap (12d since contact). David: expecting budget numbers. Tom: pipeline forecast is overdue.',
    },
  ...
  },
  {
    ...
    prepNotes: {
      lastMeetingSummary:
        "Discussed Jordan's interest in the platform team. You promised to look into an opportunity on the API redesign project.",
      openActionItems: [
      ...
      talkingPoints: [],
      attendeeContext:
        'Jordan: strong engagement, recently took on SSO architecture work.',
    },
...
const mockProjectUpdates: ProjectHealth[] = [
  {
    projectId: 'proj-1',
...
const mockIndustryIntel: IntelSignal[] = [
  {
    id: 'intel-1',
    title: 'Intercom launches AI Agent Builder for enterprise',
    summary:
      'Intercom announced their new AI Agent Builder product, targeting enterprise customers with customizable AI agents for customer support automation.',
    relevanceScore: 0.91,
    eventType: 'PRODUCT_LAUNCH',
    company: 'Intercom',
    impactOnYou:
      'This directly competes with your Q2 roadmap item "Agent Builder v2." 3 of your active prospects have also been evaluating Intercom. Sales team may need an updated competitive battlecard.',
  ...
  },
  {
    ...
    summary:
      'Acme Corp, one of your largest enterprise customers, raised $50M led by Sequoia. CEO signals expansion into new markets.',
    relevanceScore: 0.78,
    eventType: 'FUNDING_ROUND',
    company: 'Acme Corp',
    impactOnYou:
      'Acme is your 3rd largest customer by ARR. Funding typically triggers expansion — their contract renewal is in 60 days. This is a strong upsell opportunity.',
  ...
  },
  {
    ...
    summary:
      'The European Commission announced that key provisions of the EU AI Act will be enforced starting Q3 2026, 6 months earlier than expected.',
    relevanceScore: 0.65,
    eventType: 'REGULATION_CHANGE',
    impactOnYou:
      '4 of your enterprise customers are EU-based. Your AI agent product may need compliance updates before the deadline. Engineering should assess impact on the model deployment pipeline.',
...
const mockStrategicAlignment: StrategicAlignment = {
  ...
  topTimeSink: {
    ...
    percentageOfTime: 45,
    suggestion:
      'Consider converting 2 status meetings to async updates — this could free up ~3 hours/week for focused work on enterprise onboarding.',
  },
  weekOverWeekTrend: 'declining',
};

const mockWellbeingCheck: WellbeingMetrics = {
  ...
  recommendation:
    'Your sustainability score has dropped 15 points this week. Meeting load is 40% above your baseline, and focus time is critically low. Consider blocking a 2-hour focus block tomorrow morning and declining non-essential meetings.',
};

// ─── Public API ─────────────────────────────────────────────────────────────

/**
 * Fetch the complete daily briefing.
 * Simulates a network delay; will eventually call GET /api/briefing.
 */
export async function fetchDailyBriefing(): Promise<DailyBriefing> {
  ...
  return {
    ...
    priorityInbox: mockPriorityInbox,
    meetings: mockMeetings,
    projectUpdates: mockProjectUpdates,
    industryIntel: mockIndustryIntel,
    relationshipAlerts: mockRelationshipAlerts,
    strategicAlignment: mockStrategicAlignment,
    wellbeingCheck: mockWellbeingCheck,
  };
}

/**
 * Fetch only the priority inbox items.
 * Simulates a network delay; will eventually call GET /api/briefing/inbox.
 */
export async function fetchPriorityInbox(): Promise<PriorityItem[]> {
  await networkDelay();
  return mockPriorityInbox;
}

/**
 * Fetch only the project health updates.
 * Simulates a network delay; will eventually call GET /api/briefing/projects.
 */
 ...
 * Simulates a network delay; will eventually call GET /api/briefing/intel.
 */
export async function fetchIntelSignals(): Promise<IntelSignal[]> {
  await networkDelay();
  return mockIndustryIntel;
}
